...
if (localStorage.getItem("theme") == false || localStorage.getItem("theme") == "false"){
  ...
  document.getElementById("content").style.boxShadow = "rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px"
}else if(localStorage.getItem("theme") == true || localStorage.getItem("theme") == "true"){
  document.getElementById("blogpost").style.boxShadow = " ";
  document.getElementById("content").style.boxShadow = "rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px"
}
